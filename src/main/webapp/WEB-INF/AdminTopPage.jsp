		...
		<div class="row justify-content-center">
			<div class="col-md-6">
				<div class="card text-center">
					...
					<div class="card-body">
						<a href="/TASKLIST/SearchServlet" class="btn btn-primary btn-block mb-2">タスク一覧へ</a>
						<a href="/TASKLIST/adminPageServlet" class="btn btn-primary btn-block">ユーザー管理画面へ</a>
					</div>
				</div>
			</div>
		</div>
